 ...
 * @returns {any}
 */
export function parse_cli_command(command) {
    const ptr0 = passStringToWasm0(command, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_cli_command(ptr0, len0);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function list_keys() {
    const ret = wasm.list_keys();
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {Promise<any>}
 */
export function generate_key_pair(name, password) {
    const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(password, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.generate_key_pair(ptr0, len0, ptr1, len1);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function import_phrase(phrase, name, password) {
    ...
    const ret = wasm.import_phrase(ptr0, len0, ptr1, len1, ptr2, len2);
    return ret;
}
...
export function send_proof(proof_input, key_name, proving_system, game, payload, elf_input, password) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(proving_system, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    var ptr3 = isLikeNone(game) ? 0 : passStringToWasm0(game, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    ...
    const ret = wasm.send_proof(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5, ptr6, len6);
    return ret;
}

function __wbg_adapter_48(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc9f5887b822fad20(arg0, arg1);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('soundness_tui_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
